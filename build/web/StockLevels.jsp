<%-- 
    Document   : StockLevels
    Created on : Nov 29, 2014, 11:13:12 AM
    Author     : amos k mutale 
--%>
...
<form action="StockLevels.jsp" method="post" >
     
        <div ALIGN="center">
          <table 
                <tr>
                    <th colspan="2"><h2>STOCK LEVELS</h2></th>
                </tr> 
         </table>
        </div>    
</form>   
...
<%
        ...
        <td><%=metaDatat.getColumnName(3) %> </td>
        <td><%=metaDatat.getColumnName(4) %> </td>
        <td><%=metaDatat.getColumnName(5) %> </td>
