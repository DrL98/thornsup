...
public final class Sales_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 private static String ItemUnitPrice;
 private static String ItemStockID;
 private static int ItemQuantityINT;
 private static int TotalAmount;
 private static int ItemUnitPriceINT;
 private static String ItemStockTotal;
 private static int ItemStockTotalINT;
 private static int StockQuantityFinal;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write(" <title>Sales Transactions</title>\n");
      out.write("    <style> \n");
      out.write("  .textbox{\n");
      ...
      out.write("                <table width=\"600\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">\n");
      out.write("                    <tr>\n");
      out.write("                        <th colspan=\"2\"><h2>SALES TRANSACTIONS</h2></th>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <td>Stock ID:</td>\n");
      out.write("                        <td width=\"400\">\n");
      out.write("                            <select  class=\"textbox\" NAME=\"StockID\" SIZE=1>\n");
      out.write("                                <option selected=\"selected\" value=\"\">--Select item--</option> \n");
      ...
      out.write("                    </tr>  \n");
      out.write("                    <tr>\n");
      out.write("                        <td>Quantity Required:</td>\n");
      out.write("                        <td>\n");
      out.write("                            <input  class=\"textbox\" type=\"text\" name=\"quantityofsale\" value=\"\" />\n");
      out.write("                        </td>\n");
      out.write("                    </tr>\n");
      out.write("                    \n");
      out.write("                    \n");
      ...
      out.write("                        <td>&nbsp;</td>\n");
      out.write("                        <td>\n");
      out.write("                            <input type=\"hidden\" name=\"command\" value=\"Sales\" />\n");
...
try
    {//open try
               ...
               //
               {//open
               {String writeString ="SELECT * FROM Prices WHERE stockid LIKE '"+request.getParameter("StockID")+"' " ;
                    ResultSet resultIUP=state.executeQuery(writeString);//     
                    resultIUP.next();               
                    ItemUnitPrice = resultIUP.getString(2);
               }
               //calculate 
              String ItemQuant=request.getParameter("quantityofsale");
              ItemQuantityINT = Integer.parseInt(ItemQuant);
              ItemUnitPriceINT =Integer.parseInt(ItemUnitPrice);            
              //Item quantity multiplied by Item unit price
              TotalAmount =ItemQuantityINT * ItemUnitPriceINT;
            }//close      
    ...
    {//open
         {String writeString ="SELECT * FROM StockLevels WHERE stockid LIKE '"+request.getParameter("StockID")+"' " ;
                    ResultSet resultSTOTAL=state.executeQuery(writeString);//     
                    resultSTOTAL.next();               
                    ItemStockTotal = resultSTOTAL.getString(3);
         } 
                ItemStockTotalINT = Integer.parseInt(ItemStockTotal);
                StockQuantityFinal = ItemStockTotalINT - TotalAmount;
    }//close
    ...
    {//open
         {String sql = "UPDATE StockLevels SET stockQuantity = '"+StockQuantityFinal+"' WHERE stockid = '"+request.getParameter("StockID")+"' ";
    ...
    {//open state.executeUpdate("INSERT INTO StockLevels " + "( stockid) VALUES " + " ( '"+STOCKID+"' )") ;
         {String writeString ="SELECT * FROM StockLevels WHERE stockid LIKE '"+request.getParameter("StockID")+"' " ;
                    ResultSet resultSTOTAL=state.executeQuery(writeString);//     
                    resultSTOTAL.next();               
                    ItemStockTotal = resultSTOTAL.getString(3);
      ...
      out.write("            \n");
      out.write("            \n");
      out.write("            <td>Unit Price (K): ");
      out.print(ItemUnitPrice);
      out.write("  </td>\n");
      out.write("                <td>Quantity Required: ");
      out.print(ItemQuantityINT);
      out.write("  </td>\n");
      out.write("                <td>Amount (K): ");
      out.print(TotalAmount);
      out.write("  </td>   \n");
      out.write("            \n");
      out.write("            <td>StockdTotal (K): ");
      out.print(ItemStockTotalINT);
      out.write("  </td>\n");
      out.write("            \n");
      out.write("                  \n");
      out.write("            ");
